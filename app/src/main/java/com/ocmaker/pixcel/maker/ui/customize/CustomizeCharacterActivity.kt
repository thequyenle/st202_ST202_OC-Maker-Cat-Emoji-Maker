...
import com.ocmaker.pixcel.maker.core.extensions.logEvent
...
import com.ocmaker.pixcel.maker.core.extensions.startIntentLeftToRight
...
import com.ocmaker.pixcel.maker.databinding.ActivityCustomizeBinding
...
import com.ocmaker.pixcel.maker.ui.add_character.AddCharacterActivity
...
class CustomizeCharacterActivity : BaseActivity<ActivityCustomizeBinding>() {
    ...
    override fun initActionBar() {
        binding.actionBar.apply {
          ...
          //  setImageActionBar(btnReset, R.drawable.ic_reset)
